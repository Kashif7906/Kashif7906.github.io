    ...
    return (
        <Container id='contact'>
                ...
                <div className='contactText'>
                    ...
                    <div className='middleSection'>
                        <div>
                            ...
                            <a href="https://www.linkedin.com/in/kashif-jamal-290814242/" rel="noreferrer" target="_blank">
                                <p>mohd-kashif-jamal</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href="tel:+917906182087" rel="noreferrer" target="_blank">
                                <p>+917906182087</p>
                            </a>
                        </div>
                        <div>
                            ...
                            <a href='mailto:kashifjamal30@gmail.com' rel="noreferrer" target="_blank"><p>kashifjamal30@gmail.com</p></a>
                        </div>
                        <div>
                            <LocationOnIcon fontSize="large" />
                            <h1>Location</h1>
                            <p>Najibabad,Uttar Pradesh</p>
                            <a href="https://www.google.com/maps/place/Najibabad,+Uttar+Pradesh/@29.6070158,78.3266826,14z/data=!3m1!4b1!4m5!3m4!1s0x390bdf0a3da46f5d:0xd4a95803f2e9f34e!8m2!3d29.6123401!4d78.3441643" rel="noreferrer" target="_blank">
            ...
            <div className='endSection'>
                <p>© 2022 Kashif. Design by Me with <FavoriteIcon sx={{ color: '#01a479' }} /></p>
            </div>
        </Container>
    )
}
