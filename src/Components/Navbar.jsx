    ...
    return (
        <Container>
            <header className="header" style={{ backgroundColor: `${colorChange ? 'white' : 'transparent'}` }}>
                <a href="/" className="logo">Kashif</a>
                ...
                <ul className="menu">
                    ...
                    <li><div className='resumeBox'><a className='resume' href="https://drive.google.com/file/d/15W8O6yvkv3L1dK5AybbF56bVrhVvSalx/view?usp=sharing" target='_blank' rel='noreferrer'>
                        Resume<DownloadIcon />
                    </a></div></li>
                </ul>
            </header>
